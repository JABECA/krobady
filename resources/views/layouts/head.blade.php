    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse imgHome" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search">
                <input class="form-control me-2" type="search" placeholder="{{ trans('header.Search')}}" aria-label="Search">
                <button class="btn btn-outline-success" type="submit">{{ trans('header.Search')}}</button>
            </form>
            -->
      </div>
    </div>
